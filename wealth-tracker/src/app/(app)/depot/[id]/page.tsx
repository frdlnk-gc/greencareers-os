          ...
          <section className="mb-8">
            ...
            {summary.account.type !== "cash" &&
              summary.account.type !== "other" && (
                <PerformanceSection scope={id} />
              )}
          </section>

          {/* Positionen (sortierbar wie getquin) */}
          <PositionsList depotId={id} positions={summary.positions} />
        </>
      )}
    </div>
  );
...
function DepotSkeleton() {
  return (
    <div className="animate-pulse">
      <div className="mb-8">
        <div className="mb-2 h-10 w-48 rounded bg-neutral-900" />
        <div className="mb-2 h-4 w-40 rounded bg-neutral-900" />
