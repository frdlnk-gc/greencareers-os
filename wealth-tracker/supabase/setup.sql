-- Vermögens-Tracker — Komplett-Setup (einmalig ausführen).
-- Reihenfolge: 1) Schema  2) Startdaten. Nutzer vorher unter
-- Authentication -> Users anlegen, sonst bricht der Seed sauber ab.
